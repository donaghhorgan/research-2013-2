...
InverseQ::usage = "InverseQ[P] calculates the value of the inverse of the Gaussian Q-function at P. If P = Q(x), then this function returns x = \!\(\*SuperscriptBox[\(Q\), \(-1\)]\)(P).";
